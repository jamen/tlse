...
use crate::{C3DVector, CDefPointer, CxxMap, CxxPair};

#[derive(Debug)]
#[repr(C)]
pub struct CThingPlayerCreature {
    pub vmt: *mut (),
    // TODO: Bleh, its 8 bytes too big. Maybe vtables?
    // TODO: pub inherited_thing_creature_base: CThingCreatureBase,
    pub inherited_thing_creature_base: [u8; 392],
    ...
    pub relative_movement_acceleration_components: CxxMap<EGameAction, CxxPair<C3DVector, c_long>>,
