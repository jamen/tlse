//! This launches Fable.exe and injects tlse.dll.
...
fn main() {
    unsafe {
        ...
        // NOTE: Stackoverflow commenter warned "GetExitCodeThread(t1, &retVal) and returned
        // 4294967295 (retVal being a DWORD). The actual return value in the thread was -1. I just
        // figured out the ints rebounded to negatives. Sigh... – Sefu Aug 17 '11 at 23:05"
        let mut ret_val = 0;
